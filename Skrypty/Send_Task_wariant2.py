...
TinyRobot1 = robot('TinyRobot1',True,'TinyRobot1_Spawn',{'x':2.5,'y':-0.5})
TinyRobot2 = robot('TinyRobot2',True,'TinyRobot2_Spawn',{'x':7.0,'y':-0.5})
TinyRobot3 = robot('TinyRobot3',True,'TinyRobot3_Spawn',{'x':11.5,'y':-0.5})
TinyRobot4 = robot('TinyRobot4',True,'TinyRobot4_Spawn',{'x':17.5,'y':-0.5})
TinyRobot5 = robot('TinyRobot5',True,'TinyRobot5_Spawn',{'x':22.0,'y':-0.5})
TinyRobot6 = robot('TinyRobot6',True,'TinyRobot6_Spawn',{'x':2.5,'y':-23.5})
TinyRobot7 = robot('TinyRobot7',True,'TinyRobot7_Spawn',{'x':7.0,'y':-23.5})
TinyRobot8 = robot('TinyRobot8',True,'TinyRobot8_Spawn',{'x':11.5,'y':-23.5})
TinyRobot9 = robot('TinyRobot9',True,'TinyRobot9_Spawn',{'x':17.5,'y':-23.5})
TinyRobot10 = robot('TinyRobot10',True,'TinyRobot10_Spawn',{'x':22.0,'y':-23.5})
Obrabiarka0 = obrabiarka(10,True,{'x':4.0,'y':-0.5})
Obrabiarka1 = obrabiarka(10,True,{'x':8.5,'y':-0.5})
Obrabiarka2 = obrabiarka(10,True,{'x':13.0,'y':-0.5})
Obrabiarka3 = obrabiarka(4,True,{'x':19.0,'y':-0.5})
Obrabiarka4 = obrabiarka(3,True,{'x':23.5,'y':-0.5})
Obrabiarka5 = obrabiarka(6,True,{'x':23.5,'y':-23.5})
Obrabiarka6 = obrabiarka(6,True,{'x':19.0,'y':-23.5})
Obrabiarka7 = obrabiarka(6,True,{'x':13.0,'y':-23.5})
Obrabiarka8 = obrabiarka(6,True,{'x':8.5,'y':-23.5})
Obrabiarka9 = obrabiarka(5,True,{'x':4.0,'y':-23.5})
Magazyn1wej = magazyn(ilosc_przedmiotow,['MagazynWej1','Obrabiarka0'],{'x':25.0,'y':-4.0})
Magazyn2wej = magazyn(ilosc_przedmiotow,['MagazynWej2','Obrabiarka1'],{'x':25.0,'y':-7.0})
Magazyn3wej = magazyn(ilosc_przedmiotow,['MagazynWej3','Obrabiarka3'],{'x':25.0,'y':-8.5})
Magazyn4wej = magazyn(ilosc_przedmiotow,['MagazynWej4','Obrabiarka9'],{'x':25.0,'y':-10.0})
Magazyn5wej = magazyn(ilosc_przedmiotow,['MagazynWej5','Obrabiarka7'],{'x':25.0,'y':-13.0})
Magazyn6wej = magazyn(ilosc_przedmiotow,['MagazynWej6','Obrabiarka8'],{'x':25.0,'y':-16.0})
Magazyn7wej = magazyn(ilosc_przedmiotow,['MagazynWej7','Obrabiarka2'],{'x':25.0,'y':-19.0})
Magazyn8wej = magazyn(ilosc_przedmiotow,['MagazynWej8','Obrabiarka4'],{'x':25.0,'y':-20.5})
Magazyn1wyj = magazyn(0,[],{'x':1.0,'y':-4.0})
Magazyn2wyj = magazyn(0,[],{'x':1.0,'y':-8.5})
Magazyn3wyj = magazyn(0,[],{'x':1.0,'y':-13.0})
Magazyn4wyj = magazyn(0,[],{'x':1.0,'y':-19.0})
Magazyn5wyj = magazyn(0,[],{'x':1.0,'y':-4.0})
Magazyn6wyj = magazyn(0,[],{'x':1.0,'y':-8.5})
Magazyn7wyj = magazyn(0,[],{'x':1.0,'y':-13.0})
Magazyn8wyj = magazyn(0,[],{'x':1.0,'y':-19.0})
