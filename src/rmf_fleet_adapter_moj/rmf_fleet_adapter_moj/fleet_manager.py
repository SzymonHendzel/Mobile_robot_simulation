...
#Plik zarządzający robotami w tym pliku na podstawie stanów robota wykonwyane są akcje zdefiniowane przez użytkownika
import sys
import math
import yaml
import json
...
class FleetManager(Node):
    def __init__(self, config, nav_path):
        ...
        @app.get('/open-rmf/rmf_gazebo_fm/status/',
        ...
        @app.post('/open-rmf/rmf_gazebo_fm/navigate/',
                  response_model=Response)
        ...
        @app.get('/open-rmf/rmf_gazebo_fm/stop_robot/',
                 response_model=Response)
        ...
        @app.post('/open-rmf/rmf_gazebo_fm/start_task/',
                  response_model=Response)
        ...
        @app.post('/open-rmf/rmf_gazebo_fm/toggle_action/',
                  response_model=Response)
    ...
    def get_robot_state(self, robot: State, robot_name):
        ...
        if (
            ...
            or robot.state.mode.mode == RobotMode.MODE_IDLE
        ):
        ...
        data['state'] = robot.state.mode.mode
        return data
